...
class Suggestions extends Component {
  ...
  constructor(props) {
    ...
    this.scrollerEventTrap = this.scrollerEventTrap.bind(this);
  }
  ...
  shouldComponentUpdate(nextProps) {
    ...
    const shouldUpdatePos = (shouldRenderSuggestions(props.query) ||
      shouldRenderSuggestions(nextProps.query)) && props.leftStart !== nextProps.leftStart;
